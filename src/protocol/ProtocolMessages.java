...
/**
 * Protocol for NU5 GO game (final assignment 1). This is version: ‘0.1’
 */
public class ProtocolMessages {
	...
	/**
	 * The following chars are both used by the TUI to receive user input when
	 * playing with a human player, and by the server and client to distinguish
	 * messages.
	 */
	...
	// From either player (to indicate preferred color) or server (to indicate
	// assigned color)
